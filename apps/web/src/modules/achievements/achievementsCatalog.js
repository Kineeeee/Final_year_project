export const ACHIEVEMENTS = [
    ...
    },
    {
        id: 'no_mistakes',
        name: 'No Mistakes',
        description: 'Complete a match without eating wrong answers',
        category: 'learning',
        type: 'flag',
    ...
    },
    {
        id: 'arena_king',
        name: 'Arena King',
        description: 'Reach top 1 in leaderboard',
        category: 'skill',
        type: 'rank',
        metric: 'bestRank',
        target: 1,
    ...
    },
    {
        id: 'comeback_kid',
        name: 'Comeback Kid',
        description: 'From top 20 to top 5 in the same match',
        category: 'skill',
        type: 'custom',
        metric: 'comeback',
        target: 1,
    ...
    },
    {
        id: 'all_rounder',
        name: 'All-rounder',
        description: 'Eat correct answers in 5 different subjects',
        category: 'subject',
        type: 'counter',
    ...
    },
    {
        ...
        description: 'Grow extremely fast in 30s',
        category: 'secret',
        type: 'custom',
        metric: 'burstGrowth',
        target: 1,
